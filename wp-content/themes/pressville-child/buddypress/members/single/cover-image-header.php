...
<div id="cover-image-container">
	<a id="header-cover-image" href="<?php bp_displayed_user_link(); ?>" style="background-image: url(<?php echo bp_attachments_get_attachment( 'url', array( 'item_id' => bp_displayed_user_id() ) )?>);">
	</a>
